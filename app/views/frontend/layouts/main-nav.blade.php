      <nav role="navigation" class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div id="navbar-collapse-01" class="collapse navbar-collapse">
                ...
                <?php
                 $main_nav = Menu::whereMenuspackId(2)->whereParent(0)->orderBy('order')->get();
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                               ...
                               <ul class="dropdown-menu" role="menu">
                                 <li><a href="{{URL::To('customer/login')}}">Khách hàng</a></li>
                                 <li><a href="{{URL::To('domain/login')}}">Tên miền</a></li>
                               </ul>
                             </li>
